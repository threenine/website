                          ...
                          >
                            <div class="hidden sm:block flex-shrink-0">
                              <img
                                ...
                                src="https://images.unsplash.com/photo-1558478551-1a378f63328e?ixlib=rb-1.2.1&ixqx=N0pVfnVIzy&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2849&q=80"
                                alt=""
                              />
                            </div>
                            <div class="w-0 flex-1 sm:ml-8">
                              ...
                              <p class="mt-1 text-sm text-gray-500">
                                ...
                                mattis pellentesque elementum. Viverra tempor id
                                mus.
                              </p>
                            </div>
                          </a>
                        ...
                        <li class="flow-root">
                          ...
                          >
                            <div class="hidden sm:block flex-shrink-0">
                              <img
                                class="w-32 h-20 object-cover rounded-md"
                                src="https://images.unsplash.com/1/apple-gear-looking-pretty.jpg?ixlib=rb-1.2.1&ixqx=N0pVfnVIzy&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80"
                                alt=""
                              />
                            </div>
                            <div class="w-0 flex-1 sm:ml-8">
